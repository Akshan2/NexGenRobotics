...
def load():
    ...
    if platform.system() == "Windows":
        print("Using 64-bit DLL. Make sure your Python is 64-bit.")
        print("Python architecture:", platform.architecture())
        print("Loading DLL from:", dll_path)
        return CDLL(dll_path)  # ← NO RTLD_GLOBAL here

    elif platform.system() == "Darwin":
        return CDLL(os.path.join(os.path.dirname(__file__), "libDobotDll.dylib"))

    elif platform.system() == "Linux":
        return CDLL(os.path.join(os.path.dirname(__file__), "libDobotDll.so"))
